...
These tests validate that our txdelay implementation matches PyMUST outputs.
"""
...
class TestFocusedDelays:
    ...
    def test_focused_linear_array_matches_pymust(self):
        ...
        from fast_simus.txdelay import compute_focused_delays
        ...
        params = P4_2v()
        fs_delays = compute_focused_delays(params, x0=x0, z0=z0)
...
class TestPlaneWaveDelays:
    ...
    def test_plane_wave_linear_matches_pymust(self):
        ...
        from fast_simus.txdelay import compute_plane_wave_delays
        ...
        params = P4_2v()
        fs_delays = compute_plane_wave_delays(params, tilt=tilt)
...
class TestCircularWaveDelays:
    ...
    def test_circular_wave_matches_pymust(self):
        ...
        from fast_simus.txdelay import compute_circular_wave_delays
        ...
        params = P4_2v()
        fs_delays = compute_circular_wave_delays(params, tilt=tilt, width=width)
    ...
    def test_circular_wave_convex_raises_error(self):
        ...
        with pytest.raises(ValueError, match=r"Circular.*convex"):
            compute_circular_wave_delays(params, tilt=0.0, width=np.pi / 6)
...
class TestArrayAPICompliance:
    ...
    def test_focused_delays_preserves_backend(self):
        ...
        delays = compute_focused_delays(params, x0=x0, z0=z0)
    ...
    def test_plane_wave_delays_preserves_backend(self):
        ...
        delays = compute_plane_wave_delays(params, tilt=tilt)
...
class TestEdgeCases:
    ...
    def test_tilt_angle_validation(self):
        ...
        with pytest.raises(ValueError, match="Tilt"):
            compute_plane_wave_delays(params, tilt=np.pi / 2 + 0.1)
    ...
    def test_width_angle_validation(self):
        ...
        with pytest.raises(ValueError, match="Width"):
            compute_circular_wave_delays(params, tilt=0.0, width=np.pi + 0.1)

        with pytest.raises(ValueError, match="Width"):
            compute_circular_wave_delays(params, tilt=0.0, width=-0.1)
    ...
    def test_mismatched_vector_lengths(self):
        ...
        with pytest.raises(ValueError, match=r"same.*length"):
            compute_focused_delays(params, x0=x0, z0=z0)
