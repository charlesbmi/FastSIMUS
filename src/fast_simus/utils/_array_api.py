...
class Array(Protocol):
    ...
    def __eq__(self, other: int | float | complex | "Array") -> "Array": ...  # type: ignore[invalid-method-override]
    def __ne__(self, other: int | float | complex | "Array") -> "Array": ...  # type: ignore[invalid-method-override]
    def __getitem__(
