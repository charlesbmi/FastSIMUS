...
class _ArrayNamespace(Protocol):
    ...
    def max(self, x: Array, *, axis: Any = None, keepdims: bool = False) -> Array: ...
    def mean(self, x: Array, *, axis: Any = None, keepdims: bool = False) -> Array: ...
    def min(self, x: Array, *, axis: Any = None, keepdims: bool = False) -> Array: ...
