...
class _ArrayNamespace(Protocol):
    ...
    def arange(self, start: int | float, /, stop: int | float | None = None, step: int | float = 1, *, dtype: Any = None, device: Any = None) -> "Array": ...
    ...
    def linspace(self, start: int | float | complex, stop: int | float | complex, /, num: int, *, dtype: Any = None, device: Any = None, endpoint: bool = True) -> "Array": ...
