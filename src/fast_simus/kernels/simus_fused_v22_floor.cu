/*
 * v22_floor -- exp20 6-blocks/SM minimum-work floor variant.
 *
 * Base: v22_nochain (idealized + Phase 3 chain break).
 * Lever: combine nochain + __launch_bounds__(128, 6). Harness compiles
 * this variant with B_SCAT=1, ELEM_TILE=1, TILE_SE=1 (smallest possible
 * per-block working set). Cleanest possible occupancy measurement --
 * should reach 6+ blocks/SM even with spills minimal.
 *
