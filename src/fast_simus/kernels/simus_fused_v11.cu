/*
 * Fused TX+RX SIMUS kernel -- v11: batched accum + shmem TX + element tiling.
 *
 * Like v10 but Phase 3 processes ELEM_TILE elements per iteration for ILP.
 * Each frequency iteration has B_SCAT * ELEM_TILE independent compute chains.
 *
